...
# card= [[0 for x in range(50000)]for x in range(50000)]
...
for x in wire1:
    if(x[0] == "U"):
        for i in range(int(x[1:])):
            currentY += 1
            stepsTillnow += 1
            if(not(currentX in wire1Cords.keys())):
                wire1Cords[currentX] = {}
                wire1Cords[currentX][currentY] = stepsTillnow
            elif(not (currentY in wire1Cords[currentX].keys())):
                wire1Cords[currentX][currentY] = stepsTillnow
    elif(x[0] == "L"):
        for i in range(int(x[1:])):
            currentX  -= 1
...
for x in wire2:
    if(x[0] == "U"):
        for i in range(int(x[1:])):
            currentY += 1
            stepsTillnow += 1
            if(not(currentX in wire2Cords.keys())):
                wire2Cords[currentX] = {}
                wire2Cords[currentX][currentY] = stepsTillnow
            elif(not (currentY in wire2Cords[currentX].keys())):
                wire2Cords[currentX][currentY] = stepsTillnow
    elif(x[0] == "L"):
        for i in range(int(x[1:])):
            currentX  -= 1
...
keysInBoth = []
for key in wire1Cords.keys():
    if (key in wire2Cords.keys()):
...
# cordsInBoth = []
# for key in keysInBoth:
#     for cord in wire1Cords[key]:
#         if cord in wire2Cords[key]:
#             cordsInBoth.append[key,cord]
...
for key in keysInBoth:
    test1 += 1
    for cord in wire1Cords[key].keys():
        test2 +=1
        if cord in wire2Cords[key].keys():
            print("hi")
            distance.append(wire1Cords[key][cord]+wire2Cords[key][cord])



# cordsInBoth = []

# for cord in wire1Cords:
#     if cord in wire2Cords:
#         cordsInBoth.append(cord)

# distanceCords  = []

# for cord in cordsInBoth:
#     distanceCords.append(abs(cord[0])+abs(cord[1]))
